...
Pipeline
--------
1. Load and preprocess data via :class:`Preprocessing.classification_processing`.
2. Apply :class:`~sklearn.preprocessing.StandardScaler` to all numerical
   features (required by Logistic Regression for convergence).
3. Fit a default :class:`~sklearn.linear_model.LogisticRegression` with
